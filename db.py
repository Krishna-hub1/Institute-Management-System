...
class Database:
    ...
    def create_database(self):
        ...
        try:
            # Quote the database name so names containing spaces are valid MySQL identifiers.
    ...
    def create_tables(self):
        ...
        try:
            ...
            # Upgrade an already-existing attendance table created by an older version.
            self.cursor.execute(
                """
            ...
            if self.cursor.fetchone()["column_exists"] == 0:
                self.cursor.execute("ALTER TABLE attendance ADD COLUMN remarks TEXT")
